...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void noOptionalAttendeeSlots() {
    // Have each person have different events. An optional attendee has a whole day event,
    // so we should see only the options that allow mandatory attendees.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAndMandatoryAttendeesAreConsidered() {
    // Have each person have different events. We should only see options that all attendees,
    // including optional attendees, can attend.
    //
    // Events  :       |--A--|--C--|--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  @Test
  public void prioritizeMandatoryAttendeesJustEnoughRoom() {
    // Considering the optional attendees means there is not enough time for the meeting, so only
    // times that work for mandatory attendees is returned.
    //
    // Events  : |--A--|B-|  |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void optionalAttendeeIsConsidered() {
    ...
    // person has split the restricted times. There are no mandatory attendees.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void notEnoughRoomNoMandatoryAttendees() {
    // Have one optional attendee, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A-----| |-----A----|
    // Day     : |---------------------|
